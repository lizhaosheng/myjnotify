...
public class JNotify_macosx
{
	...
	static
	{
//		System.loadLibrary("jnotify_mac.jnilib"); //$NON-NLS-1$
		try
		{
			String path = JNotifyConstant.LIB_CLASS_PATH + "/libjnotify_mac.jnilib";
			System.out.println("try to load '" + path + "' from classpath");
			File lib = Util.getTempLib(path, ".jnilib");
			System.load(lib.getAbsolutePath());
		}
		catch (UnsatisfiedLinkError e)
		{
			System.err.println("load libjnotify_mac.jnilib failed!\n" + e.getMessage());
			e.printStackTrace();
		}
